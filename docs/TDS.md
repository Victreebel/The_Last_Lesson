...
| `I` / `UPLINK` | Toggle the Tactical Uplink's live operation brief. It begins collapsed at compact desktop/tablet widths to preserve upper-left battlefield space, while wide displays begin expanded. This is presentation-only and `Esc` closes it with other temporary surfaces. |
